                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-lg-7 left-large-content mt-3">
                            <img src="{{ asset('front/images/Image-2_copy_1.png') }}" alt="" class="left-large-section-img shadow">
                        ...
                        <div class="col-md-12 col-lg-7 mt-3 eb_main_img_section_2">
                            <div class="row ">
                                <div class="col-12 right-large-section-image pl-5">
                                    <img src="{{ asset('front/images/Image-3_copy_1.png') }}" alt="" class="right-large-section-img shadow">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-lg-7 mt-3">
                            <img src="{{ asset('front/images/Image-4_copy_1.png') }}" alt="" class="left-large-section-img shadow">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-7 mt-3 eb_main_img_section_4">
                            <div class="row">
                                <div class="col-12 right-large-section-image pl-5">
                                    <img src="{{ asset('front/images/Image-5_copy_1.png') }}" alt="" class="right-large-section-img shadow">
                            ...
                            <div class="slick-slider">
                                <div class="compliment-slider">
                                    <div class="slider-content mt-5">
                                        <img class="slider-content-img" src="{{ asset('front/images/card-author-1.jpeg') }}">
                                ...
                                <div class="col-sm-12 col-md-6 compliment-slider">
                                    <div class="slider-content mt-5">
                                        <img class="slider-content-img" src="{{ asset('front/images/Cregy.jpeg') }}">
                                        <h1 class="slider-profile-name">Richard Brown</h1>
                                        <P class="slider-profile-post">Community Organiser</P>
                                        <p class="slider-profile-compliment">I have been looking for an ERP/CRM to manage invoices and customers for
                                            sometime now.
                                ...
                                <div class="col-sm-12 col-md-6 compliment-slider">
                                    <div class="slider-content mt-5">
                                        <img class="slider-content-img" src="{{ asset('front/images/fazle-rabbi.jpeg') }}">
                                        <h1 class="slider-profile-name">Richard Brown</h1>
                                        <P class="slider-profile-post">Community Organiser</P>
                                        <p class="slider-profile-compliment">I have been looking for an ERP/CRM to manage invoices and customers for
                                            sometime now.
                                ...
                                <div class="col-sm-12 col-md-6 compliment-slider">
                                    <div class="slider-content mt-5">
                                        <img class="slider-content-img" src="{{ asset('front/images/Shubnam.jpeg') }}">
                                        <h1 class="slider-profile-name">Richard Brown</h1>
                                        <P class="slider-profile-post">Community Organiser</P>
                                        <p class="slider-profile-compliment">I have been looking for an ERP/CRM to manage invoices and customers for
                                            sometime now.
