                                    ...
                                    <h4 class="text-center">Upload Gif Image</h4>
                                      ...
                                      <div class="form-row">
                                        <div class="form-group col-12">
                                          ...
                                          <input id="profile-select1"type="file" name="gif1" style="display:none; width: 70%; overflow: hidden;">
                                        ...
                                        <div class="form-group col-12">
                                          ...
                                          <input id="profile-select2"type="file" name="gif2" style="display:none; width: 70%; overflow: hidden;">
                                        ...
                                        <div class="form-group col-12">
                                          ...
                                          <input id="profile-select3"type="file" name="gif3" style="display:none; width: 70%; overflow: hidden;">
