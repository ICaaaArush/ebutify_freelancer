                              ...
                              <div class="row">
                                ...
                                <div class="link-box my-1">
                                    <h4 class="text-center">Upload Gif Image</h4>
                                      ...
                                      <div class="form-row">
                                        <div class="form-group col-12">
                                          <img class="form-group" src="{{asset('storage/'.$productImages->gif_1)}}" style="width: 80px;" alt="No GIF Yet">
                                          <input class="form-group" id="profile-input1" type="text" class="form-control" style="width: 70%; display: initial;">
                                          <input class="form-group" id="profile-select1" accept=".png, .jpg, .jpeg, .gif" type="file" name="gif1" style="display:none; width: 70%; overflow: hidden;">
                                          <button type="button" onclick="profileSelect1()" class="btn btn-outline-none btn-transparent" style="padding: 0; overflow: hidden;"><img src="{{asset('assets/img/Group-315.png')}}" style="width: 35px;"></button>
                                        </div>
                                        <div class="form-group col-12">
                                          <img class="form-group" src="{{asset('storage/'.$productImages->gif_2)}}" style="width: 80px;" alt="No GIF Yet">
                                          <input class="form-group" id="profile-input2" type="text" class="form-control" style="width: 70%; display: initial;">
                                          <input class="form-group" id="profile-select2" accept=".png, .jpg, .jpeg, .gif" type="file" name="gif2" style="display:none; width: 70%; overflow: hidden;">
                                          <button type="button" onclick="profileSelect2()" class="btn btn-outline-none btn-transparent" style="padding: 0; overflow: hidden;"><img src="{{asset('assets/img/Group-315.png')}}" style="width: 35px;"></button>
                                        </div>
                                        <div class="form-group col-12">
                                          <img class="form-group" src="{{asset('storage/'.$productImages->gif_3)}}" style="width: 80px;" alt="No GIF Yet">
                                          <input class="form-group" id="profile-input3" type="text" class="form-control" style="width: 70%; display: initial;">
                                          <input class="form-group" id="profile-select3" accept=".png, .jpg, .jpeg, .gif" type="file" name="gif3" style="display:none; width: 70%; overflow: hidden;">
                                          <button type="button" onclick="profileSelect3()" class="btn btn-outline-none btn-transparent" style="padding: 0; overflow: hidden;"><img src="{{asset('assets/img/Group-315.png')}}" style="width: 35px;"></button>
                                        </div>
