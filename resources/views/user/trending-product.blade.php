          ...
          <div class="card-deck">
            <div class="card shadow">
              <div class="row px-2 video-icon">
                <img src="assets/img/shopping1.jpg" class="card-img-top img-fluid" alt="...">
              ...
              <div class="row card-body px-2">
                <div class="col-12 pb-1 px-3" style="border-bottom: 2px solid #DCDCDC;">
                  <h5 class="card-title">Ocean Terrace Landscape Tray ….</h5>
                </div>
              ...
              <div class="row mx-4 px-2 mb-2 justify-content-center rounded icon-btn">
                <a href="view-product-details-(modal).html" type="button" class="btn fb-ads-card-btn">View Product Details</a>
              </div>
            </div>
            <div class="card shadow">
              <div class="row px-2 video-icon">
                <img src="assets/img/shopping3.jpg" class="card-img-top img-fluid" alt="...">
                <i class="fas fa-play-circle video-play-icon"></i>
              </div>
              <div class="row card-body px-2">
                <div class="col-12 pb-1 px-3" style="border-bottom: 2px solid #DCDCDC;">
